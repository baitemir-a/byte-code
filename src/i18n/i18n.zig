...
pub const Strings = struct {
    ...
    git: struct {
        ...
        /// What a stopped rebase, cherry-pick or revert offers: to call it
        /// off, to go on (the commit button), or to leave out its commit.
        abort_rebase: []const u8,
        abort_cherry_pick: []const u8,
        abort_revert: []const u8,
        continue_rebase: []const u8,
        continue_cherry_pick: []const u8,
        continue_revert: []const u8,
        skip_rebase: []const u8,
        rebase_onto: []const u8,
        cherry_pick: []const u8,
        compare_branch: []const u8,
        create_tag: []const u8,
        delete_tag: []const u8,
        push_tags: []const u8,
        pick_rebase: []const u8,
        pick_cherry_branch: []const u8,
        pick_cherry_commit: []const u8,
        pick_compare: []const u8,
        pick_compare_file: []const u8,
        pick_tag_delete: []const u8,
        revert_commit: []const u8,
        revert_question: []const u8,
        revert_detail: []const u8,
        abort_question: []const u8,
        abort_detail: []const u8,
        tag_title: []const u8,
        tag_name: []const u8,
        tag_message_title: []const u8,
        tag_message: []const u8,
        delete_tag_question: []const u8,
        delete_tag_detail: []const u8,
        running_push_tags: []const u8,
    },
